...
import click
import gitlab
from nemo_ci_triage.notifications import notification
...
def get_pipeline_jobs(pipeline_id: int, job_prefix: str) -> list[tuple[str, int, list[dict]]]:
    """Collect Megatron's direct child pipelines using nemo-ci-triage."""
...
def configure_notification_urls() -> None:
    """Point the package's generic notification links at Megatron-LM."""
