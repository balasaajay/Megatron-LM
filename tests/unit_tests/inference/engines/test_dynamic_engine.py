...
class TestDynamicInferenceEngine:
    ...
    def _build_inference_context(
        ...
        context = DynamicInferenceContext(
            ...
            inference_config=InferenceConfig(
                ...
                request_bookkeeping_lag=test_config.request_bookkeeping_lag,
            ),
        )
    ...
    @pytest.mark.parametrize("request_bookkeeping_lag", [0, 16])
    async def test_run_engine_with_bookkeeping_lag(self, request_bookkeeping_lag: int):
        """Correctness of the async bookkeep path at various lag values.
        ...
        with torch.inference_mode():
            ...
            test_config = DynamicEngineTestConfig(
                ...
                request_bookkeeping_lag=request_bookkeeping_lag,
            )
            env = self._build_test_env(test_config)
            ...
            try:
                ...
                ), f"No evictions triggered (lag={request_bookkeeping_lag})"
