...
def _add_inference_args(parser):
    ...
    group.add_argument('--inference-request-bookkeeping-lag', type=int, default=-1,
                       help='How many steps bookkeeping is allowed to fall behind '
                            'the forward step. -1 means unlimited. 0 means synchronous.')
