...
def get_fault_delay(cli_args):
    """Return fault delay in seconds; 0.0 for iteration-based, sampled or fixed for time-based."""
    global rng

    if cli_args.fault_injector_fault_iteration is not None:
        assert (
            cli_args.fault_injector_fault_delay is None
            and cli_args.fault_injector_mtti_seconds is None
